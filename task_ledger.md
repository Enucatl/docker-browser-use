...
| T027 | Explicit Bitwarden actions (`LOGIN` / `IDENTITY` / `CARD`) | T015, T026, T008 | done | [tasks/T027.md](tasks/T027.md) |
...
| T034 | Optional MinIO backend for artifact storage | T007 | done | [tasks/T034.md](tasks/T034.md) |
| T035 | Periodic signed audit checkpoints | T009 | done | [tasks/T035.md](tasks/T035.md) |
